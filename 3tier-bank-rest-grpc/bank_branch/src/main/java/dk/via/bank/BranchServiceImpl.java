...
public class BranchServiceImpl extends BranchGrpc.BranchImplBase {
    ...
    protected BranchServiceImpl(BranchCustomerService customerService, BranchAccountService accountService, BranchTransactionService transactionService, BranchExchangeService exchangeService) {
